...
uint256 hashGenesisBlock("0x5b4d1532f54b65e09dce1179bcee52ae219f54ef04f2d444a36450b3d51d4f7e");
...
const string strMessageMagic = "HeapCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // HeapCoin: 1 days
static const int64 nTargetSpacing = 120; // HeapCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal heapcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HeapCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x539cf2f51fa802d03adf20f9cdf4e6bb602639377185561f5bae2cb589312820");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Ethereum Launches Own ‘Ether’ Coin, With Millions Already Sold";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1406145803; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 190905;

        if (fTestNet)
        {
            block.nTime    = 1406140626;
            block.nNonce   = 454577;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2ecdb42b695067f256475f1b3287ab3309c35c70254a682a5472adde9cf0c346"));
